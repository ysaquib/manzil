...
│   ├── tests/fixtures/
│   │   ├── corpus/              # 50+ saved real listing pages (committed to git)
│   │   ├── bench/               # stratified ~20 + manifest.md (why each was chosen)
│   │   └── recorded/            # captured LLM responses — CI replays, never calls live

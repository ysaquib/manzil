...
| ENRICH | Maps distances/commutes, ratings per the [§10.12](#1012-ratings-sources) source ladder (Places first), safety synthesis (low-confidence by design), utility baseline application | small + APIs | Safety data is knowingly weak — do not over-invest ([§17](#17-risks-and-concerns-register)) |

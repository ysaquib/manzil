...
**Phase 3 (DESIGN.md §19) — formally entered 2026-07-18.** Landed: P3-2 planner/manifest runner, P3-3 tool registry/Maps, P3-4 DEDUPE/reversal, **P3-5 DISCOVER** (2026-07-21, DESIGN v3.8 / IMPLEMENTATION 2.0.70: OpenRouter native search, exact same-Property candidate filtering, official link-only persistence, tier/family slate, editable Source Policy, reasoned single-source badge), **P3-SC2 scoped Extraction foundation** (2026-07-21, DESIGN v3.9 / IMPLEMENTATION 2.0.71: append-only candidate/resolved facts, Source-local Floor Plan identity, centralized current views/effective resolver, scoped Overrides, authoritative refresh and same-Property guards), and P3-7a image substrate. P3-8 and P3-9 are landed ◐ with their live/bench follow-ups recorded in IMPLEMENTATION. P3-7b remains fail-closed pending the approved reference set. The SSRF gate and Google Maps credential gate are cleared. P3-14 remains scoped to Bright Data's free plan and the five census-named hostile domains. The P0-14 pin moves only EXTRACT/VERIFY to `gemini-3-flash-preview`; unbenched stages keep their Anthropic tier. Plan: `.claude/plans/phase-3-agent-system.md`. **Next: P3-SC3**, then P3-SC4; P3-6 begins only after P3-SC4 because its P3-5 dependency is now complete.

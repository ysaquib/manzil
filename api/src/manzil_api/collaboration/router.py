...
async def create_comment(
    ...
    return await service.create_comment(client, listing_id, user.id, body)
...
@router.put("/listings/{listing_id}/rating", response_model=RatingResponse)
async def upsert_rating(
    ...
    return await service.upsert_rating(client, listing_id, user.id, body)
...
async def delete_rating(
    ...
    await service.delete_rating(client, listing_id, user.id)
